<template>
    <div><!--面包屑导航区域-->
        ...
        <el-card>
            ...
            <!-- 表单区域 -->
            <!-- 这里存在一个严格的嵌套关系，即form表单不能放在 el-tabs 和 el-tab-pane 之间，只能 form => el-tab => el-tab-pane -->
...
export default {
    ...
    methods:{
        ...
        beforeTabLeave(activeName,oldActiveName){
            /* console.log('即将离开的标签页的名字是：' 
            + oldActiveName)
            console.log('即将进入的标签页的名字是：' 
            + activeName) */
        ...
        handleRemove(file){
            ...
            /* x.pic === filePath) */
            //3、调用数组的splice 方法，把图片信息对象从 pics 数组中删除
        ...
        add(){
            ...
            this.$refs.addFormRef.validate(async valid=>{
                ...
                //执行添加的业务逻辑
                //lodash  cloneDeep(obj),通过导入lodash 然后调用解决级联选择器要求数组，而数据库要求字符串的问题
                //第二种方法是直接使用JSON的stringify方法
